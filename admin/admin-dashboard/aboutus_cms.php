        ...
        <div class="row">
            <div class="col-md-4">
                <form action="aaction.php" method="post" enctype="multipart/form-data">
                    <label>Add Descripion</label>
                    <textarea name="description" id="" cols="30" rows="10"></textarea><br><br>
                    <span>Upload Image:</span><input type="file" name="image"> <br><br>
                    <button class="btn btn-success"type="submit" name="insertabout">Submit</button><br><br>
                </form>
            </div>
            <div class="col-md-7">
